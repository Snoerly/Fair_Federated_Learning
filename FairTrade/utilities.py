...
def find_ate_score(protected_attr, labels, predictions):
    protected_pos = 0.0
    protected_neg = 0.0
    non_protected_pos = 0.0
    non_protected_neg = 0.0
    ...
    for i in range(len(protected_attr)):
        ...
        if protected_attr[i] == saValue:
            ...
            if predictions[i] == 1:
                non_protected_pos += 1.0
            else:
                non_protected_neg += 1.0
...
def find_eqop_score(self, data, labels, predictions):
    ...
    tp_non_protected = 0.0
    tn_non_protected = 0.0
    fp_non_protected = 0.0
    fn_non_protected = 0.0
    saIndex = 2
    saValue = 0
    for idx, val in enumerate(data):
        ...
        if val[saIndex] == saValue:
            ...
            if labels[idx] == predictions[idx]:
                if labels[idx] == 1:
                    tp_non_protected += 1.0
                else:
                    tn_non_protected += 1.0
            # misclassified
            else:
                if labels[idx] == 1:
                    fn_non_protected += 1.0
                else:
                    fp_non_protected += 1.0
